...
void GestorRunde::onEveniment(const std::string& tip, int valoare) {
    ...
    switch (runda) {
        case 1:  intervalMiscare = 6.0; maxInamici = 8;  culoare = 0x29b6f6; break; // albastru
        case 2:  intervalMiscare = 4.5; maxInamici = 10; culoare = 0x66bb6a; break; // verde
        case 3:  intervalMiscare = 3.0; maxInamici = 12; culoare = 0xffa726; break; // portocaliu
        default: intervalMiscare = 2.0; maxInamici = 14; culoare = 0xef5350; break; // rosu
    }
